...
localizations.values = {
    ...
    resource_rock = "Large Pedra",
    resource_rock_plural = "Large Pedras",
    resource_dirt = "Terra",
    ...
    resource_grass_plural = "Feno Úmido",
    ...
    resource_deadChickenRotten = "Rotten Carcaça de Galinha",
    resource_deadChickenRotten_plural = "Rotten Carcaças de Galinha",
    ...
    resource_unfiredUrnWet_plural = "Vasos não Queimados (Úmido)",
    ...
    resource_mammothMeat_plural = "Carne de Mamute",
    resource_mammothMeatCooked = "Cooked Carne de Mamute",
    resource_mammothMeatCooked_plural = "Cooked Carne de Mamute",
