...
localizations.values = {
    ...
    craftable_stonePickaxe_summary = "Pode ser usada para minerar pedras e cavar mais facilmente.",
    craftable_flintPickaxe = "Picareta de Pederneira",
    craftable_flintPickaxe_plural = "Picaretas de Pederneira",
    craftable_flintPickaxe_summary = "Pode ser usada para minerar pedras e cavar mais facilmente.",
    ...
    craftable_stoneAxeHead_summary = "Pode ser usada para cortar madeira e cavar o chão.",
    craftable_flintAxeHead = "Flint Hand Axe",
    craftable_flintAxeHead_plural = "Flint Hand Axes",
    craftable_flintAxeHead_summary = "Pode ser usada para cortar madeira e cavar o chão.",
    ...
    --flora
    flora_willow = "Willow Árvore",
    flora_willow_plural = "Willow Árvores",
    flora_willow_summary = "Found near rivers, willow trees provide a strong but twisted wood.",
    flora_willow_sapling = "Willow Muda",
    flora_willow_sapling_plural = "Willow Mudas",
    ...
    flora_aspen = "Álamo Árvore",
    flora_aspen_plural = "Álamo Árvores",
    flora_aspen_summary = "A tall deciduous tree native to cold regions. Supplies a light wood with white bark.",
    flora_aspen_sapling = "Álamo Muda",
    flora_aspen_sapling_plural = "Álamo Mudas",
    flora_bamboo = "Bamboo",
    ...
    flora_bamboo_sapling = "Bamboo Muda",
    flora_bamboo_sapling_plural = "Bamboo Mudas",
    flora_palm = "Palm Árvore",
    flora_palm_plural = "Palm Árvores",
    flora_palm_summary = "Palm Árvore",
    flora_palm_sapling = "Palm Muda",
    flora_palm_sapling_plural = "Palm Mudas",
    flora_birch = "Birch Árvore",
    flora_birch_plural = "Birch Árvores",
    flora_birch_summary = "A quite compact deciduous tree that supplies a light wood with white bark.",
    flora_birch_sapling = "Birch Muda",
    flora_birch_sapling_plural = "Birch Mudas",
    flora_pine = "Pine Árvore",
    flora_pine_plural = "Pine Árvores",
    ...
    flora_pine_sapling = "Pine Muda",
    flora_pine_sapling_plural = "Pine Mudas",
    flora_pineBig = "Tall Pine Árvore",
    flora_pineBig_plural = "Tall Pine Árvores",
    ...
    flora_pineBig_sapling = "Tall Pine Muda",
    flora_pineBig_sapling_plural = "Tall Pine Mudas",
    flora_aspenBig = "Tall Álamo Árvore",
    flora_aspenBig_plural = "Tall Álamo Árvores",
    ...
    flora_aspenBig_sapling = "Tall Álamo Muda",
    flora_aspenBig_sapling_plural = "Tall Álamo Mudas",
    flora_appleTree = "Apple Árvore",
    flora_appleTree_plural = "Apple Árvores",
    flora_appleTree_summary = "A compact deciduous tree, that provides fruit from late summer to autumn.",
    flora_appleTree_sapling = "Apple Muda",
    flora_appleTree_sapling_plural = "Apple Mudas",
    ...
    flora_peachTree = "Peach Árvore",
    flora_peachTree_plural = "Peach Árvores",
    flora_peachTree_summary = "Provides a juicy stone fruit, ready to eat in summer.",
    flora_peachTree_sapling = "Peach Muda",
    flora_peachTree_sapling_plural = "Peach Mudas",
    flora_bananaTree = "Banana Árvore",
    flora_bananaTree_plural = "Banana Árvores",
    ...
    flora_bananaTree_sapling = "Banana Muda",
    flora_bananaTree_sapling_plural = "Banana Mudas",
    flora_coconutTree = "Coconut Árvore",
    flora_coconutTree_plural = "Coconut Árvores",
    ...
    flora_coconutTree_sapling = "Coconut Muda",
    flora_coconutTree_sapling_plural = "Coconut Mudas",
    ...
    flora_orangeTree = "Orange Árvore",
    flora_orangeTree_plural = "Orange Árvores",
    flora_orangeTree_summary = "Orange trees are hardy and provide an often much needed harvest in late winter.",
    flora_orangeTree_sapling = "Orange Muda",
    flora_orangeTree_sapling_plural = "Orange Mudas",
    flora_cactus = "Cactus",
    flora_cactus_plural = "Cacti",
    flora_cactus_summary = "Cactus",
    flora_cactus_sapling = "Cactus Muda",
    flora_cactus_sapling_plural = "Cactus Mudas",
    ...
    flora_sunflowerSapling = "Sunflower Muda",
    flora_sunflowerSapling_plural = "Sunflower Mudas",
    flora_flower1 = "Flor",
    flora_flower1_plural = "Flores",
    flora_flower1_summary = "Flor",
    
    -- branches
    branch_birch = "Birch Galho",
    branch_birch_plural = "Birch Galhos",
    branch_pine = "Pine Galho",
    branch_pine_plural = "Pine Galhos",
    branch_aspen = "Álamo Galho",
    branch_aspen_plural = "Álamo Galhos",
    branch_bamboo = "Bamboo",
    branch_bamboo_plural = "Bamboo",
    branch_willow = "Willow Galho",
    branch_willow_plural = "Willow Galhos",
    branch_apple = "Apple Galho",
    branch_apple_plural = "Apple Galhos",
    branch_orange = "Orange Galho",
    branch_orange_plural = "Orange Galhos",
    branch_peach = "Peach Galho",
    branch_peach_plural = "Peach Galhos",

    -- logs
    log_birch = "Birch Tronco",
    log_birch_plural = "Birch Troncos",
    log_willow = "Willow Tronco",
    log_willow_plural = "Willow Troncos",
    log_apple = "Apple Tronco",
    log_apple_plural = "Apple Troncos",
    log_orange = "Orange Tronco",
    log_orange_plural = "Orange Troncos",
    log_peach = "Peach Tronco",
    log_peach_plural = "Peach Troncos",
    log_pine = "Pine Tronco",
    log_pine_plural = "Pine Troncos",
    log_aspen = "Álamo Tronco",
    log_aspen_plural = "Álamo Troncos",
    log_coconut = "Coconut Tronco",
    log_coconut_plural = "Coconut Troncos",
    ...
    fruit_aspenBigSeed = "Tall Álamo Semente",
    fruit_aspenBigSeed_plural = "Tall Álamo Sementes",
    fruit_aspenBigSeed_rotten = "Rotten Tall Álamo Semente",
    fruit_aspenBigSeed_rotten_plural = "Rotten Tall Álamo Sementes",
    ...
    fruit_beetrootSeed = "Beetroot Semente",
    fruit_beetrootSeed_plural = "Beetroot Sementes",
    fruit_beetrootSeed_rotten = "Rotten Beetroot Semente",
    fruit_beetrootSeed_rotten_plural = "Rotten Beetroot Sementes",
    fruit_wheat = "Wheat",
    ...
    fruit_flaxSeed = "Flax Semente",
    fruit_flaxSeed_plural = "Flax Sementes",
    fruit_flaxSeed_rotten = "Rotten Flax Semente",
    fruit_flaxSeed_rotten_plural = "Rotten Flax Sementes",
    fruit_sunflowerSeed = "Sunflower Semente",
    fruit_sunflowerSeed_plural = "Sunflower Sementes",
    fruit_sunflowerSeed_rotten = "Rotten Sunflower Semente",
    fruit_sunflowerSeed_rotten_plural = "Rotten Sunflower Sementes",
    fruit_peach = "Peach",
    ...
    fruit_birchSeed = "Birch Semente",
    fruit_birchSeed_plural = "Birch Sementes",
    fruit_birchSeed_rotten = "Rotten Birch Semente",
    fruit_birchSeed_rotten_plural = "Rotten Birch Sementes",
    fruit_aspenSeed = "Álamo Semente",
    fruit_aspenSeed_plural = "Álamo Sementes",
    fruit_aspenSeed_rotten = "Rotten Álamo Semente",
    fruit_aspenSeed_rotten_plural = "Rotten Álamo Sementes",
    fruit_willowSeed = "Willow Semente",
    fruit_willowSeed_plural = "Willow Sementes",
    fruit_willowSeed_rotten = "Rotten Willow Semente",
    fruit_willowSeed_rotten_plural = "Rotten Willow Sementes",
    fruit_bambooSeed = "Bamboo Semente",
    fruit_bambooSeed_plural = "Bamboo Sementes",
    fruit_bambooSeed_rotten = "Rotten Bamboo Semente",
    fruit_bambooSeed_rotten_plural = "Rotten Bamboo Sementes",
    ...
    object_peachWoodenPole = "Peach de Madeira Poste",
    object_peachWoodenPole_plural = "Peach de Madeira Postes",
    ...
    object_peachSplitLog = "Peach Tronco Cortado",
    object_peachSplitLog_plural = "Peach Troncos Cortados de",
