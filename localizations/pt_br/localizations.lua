...
localizations.values = {
	...
	craftable_rockSmallSoft = "Pedra Macia Pequena", --0.4
    craftable_rockSmallSoft_plural = "Pedras Macias Pequenas", --0.4
    ...
    craftable_stoneAxeHead = "Cabeça de Machado de Pedra (Dura)", --0.4 added "(Hard Rock)"
    craftable_stoneAxeHead_plural = "Cabeças de Machado de Pedra (Dura)", --0.4 added "(Hard Rock)"
	...
	craftable_stoneAxeHeadSoft = "Machadinha de Pedra (Macia)", --0.4
    craftable_stoneAxeHeadSoft_plural = "Machadinhas de Pedra (Macia)", --0.4
    ...
    craftable_stoneTileSoft = "Ladrilho de Pedra (Macia)", --0.4
    craftable_stoneTileSoft_plural = "Ladrilhos de Pedra (Macia)", --0.4
